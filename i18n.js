(function () {
  ...
  const dictionaries = {
    en: {
      ...
      "四.本 App 中文介面中的主頁副標短語為原創文案，僅作為使用體驗上的裝飾與提醒，不代表引用任何視聽、文學或其他作品原文，亦不代表與任何第三方作品、作者、出版社或影視公司存在合作、授權、贊助或背書關係。": "4. The main-page subtitle phrases in this app's Chinese interface are original copy used only as decorative reminders for the user experience. They do not quote any audiovisual, literary, or other work, and do not imply collaboration, authorization, sponsorship, or endorsement by any third-party work, author, publisher, or film or television company.",
      "版本": "Version",
    ...
    ja: {
      ...
      "四.本 App 中文介面中的主頁副標短語為原創文案，僅作為使用體驗上的裝飾與提醒，不代表引用任何視聽、文學或其他作品原文，亦不代表與任何第三方作品、作者、出版社或影視公司存在合作、授權、贊助或背書關係。": "4. 本アプリの中国語インターフェースに表示されるホーム画面の副題フレーズは、利用体験上の装飾および注意喚起のみを目的としたオリジナル文案です。映像・文学その他の作品の原文を引用するものではなく、第三者の作品、著者、出版社、映像会社との提携、許諾、協賛、推奨関係を示すものでもありません。",
      "版本": "バージョン",
