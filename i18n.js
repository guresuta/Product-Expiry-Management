(function () {
  ...
  const dictionaries = {
    en: {
      ...
      "- 快速掌握商品效期，提前發現即期與過期風險 -": "- Track expiry dates and risks early -",
      "新 增 商 品": "Add Product",
      "設 定": "Settings",
      "系 統": "System",
      "設定": "Settings",
      "返 回": "Back",
      "商 品": "Products",
      "商品效期趨勢分析": "Product Expiry Trend Analysis",
      "商 品 效 期 趨 勢 分 析": "Product Expiry Trend Analysis",
      "備 份 資 料 J S O N": "Back Up JSON",
      "應 用 程 式 資 訊": "App Info",
      "依照目前商品資料即時計算效期與分類風險": "Real-time expiry and category risk analysis from current product data",
      "- 依照目前商品資料即時計算效期與過期比例 -": "- Live expiry and expired ratio analysis -",
      "商品效期概況": "Product Expiry Overview",
      "分類商品數量分布": "Products by Category",
      "到期日時間分布趨勢": "Expiry Timeline",
      "商品分類健康狀態": "Category Status",
      "分類商品即期風險": "Near-Expiry Risk by Category",
      "商品分類過期比例": "Expired Ratio by Category",
      "分類商品過期比例": "Expired Ratio by Category",
      ...
      "總筆數": "Total Products",
      "筆數": "Cnt",
      "已過期筆數": "Expired Products",
      "過期數": "EXP",
      "過期比例": "Expired Ratio",
      "歷史過期趨勢": "Historical Expiry Trend",
      "月份": "Month",
      "過期率": "Expired Rate",
      "分類歷史過期統計": "Category Expiry History",
      "新增數": "Added",
      "刪除數": "Deleted",
      "尚無歷史紀錄": "No history yet",
      "歷史資料會保留商品異動與到期的每月彙總；刪除商品不會清除既有統計。": "Monthly summaries keep product changes and expiries. Deleting a product does not erase existing statistics.",
      "比例": "Ratio",
      "高風險": "High Risk",
      "中等風險": "Medium Risk",
      "低風險": "Low Risk",
      "平均效期天數": "Average Days Until Expiry",
      "天": " days",
      "無資料": "No data",
      ...
      "31-60天內到期": "Due in 31-60 days",
      "全選商品": "Select all products",
      "全選": "Select all",
      "排序: 有效日期": "Sort: Expiry date",
      "排序: 商品名稱": "Sort: Product name",
      "排序: 條碼": "Sort: Barcode",
      "排序: 陳列層": "Sort: Shelf No.",
      "排序: 狀態": "Sort: Status",
      ...
      "條碼掃描": "Barcode Scan",
      "請把條碼對準鏡頭中央。相機影像只在本機辨識，不會上傳。": "Place the barcode in the center of the camera view. Camera images are recognized locally and are not uploaded.",
      "請把條碼對準鏡頭中央。": "Place the barcode in the center of the camera view.",
      "關閉掃描": "Close Scanner",
      ...
      "確定": "Confirm",
      "資料備份提醒": "Data Backup Reminder",
      "請先使用「備份資料 JSON 」建立備份，後續更新的版本只會使用本機 IndexedDB做為資料儲存方式 ，目前版本的程式會自動將先前指定的本機檔案位置匯入資料庫。若曾使用「本機檔案位置」，請在下一個程式版本更新前匯出JSON ，並在更新後用「還原資料 JSON 」恢復資料。": "Create a backup first with Back Up JSON.\n\nFuture versions will use only IndexedDB on this device. The current version automatically imports the previously selected local file into the database.\n\nIf you used Local File, export JSON before updating to the next app version, then restore your data with Restore JSON Backup after updating.",
      "了解並繼續": "Got it, continue",
      ...
      "已將舊本機檔案資料移入本機資料庫，請匯出 JSON 建立新備份。": "Legacy local-file data was moved into the local database. Export JSON to create a new backup.",
      "CSV 匯出成功": "CSV export complete",
      "JSON 備份失敗": "JSON backup failed",
      "CSV 匯出失敗": "CSV export failed",
      "CSV 匯出": "CSV export",
      "JSON 還原": "JSON restore",
      "瀏覽器不支援確認檔案儲存": "This browser cannot confirm that the file was saved",
      "瀏覽器不支援確認檔案選擇": "This browser cannot confirm file selection",
      ...
      "已取消選擇檔案": "File selection canceled",
      "檔案寫入失敗": "Failed to write the file",
      "無法開啟檔案選擇器": "Unable to open the file picker",
      "檔案選擇器尚未就緒": "The file picker is not ready",
      "無法開啟檔案": "Unable to open the file",
      "原生條碼掃描失敗": "Native barcode scanning failed",
      "原生條碼掃描無法啟動": "Unable to start native barcode scanning",
      "原生條碼掃描尚未就緒": "Native barcode scanning is not ready",
      ...
      "庫存請輸入 0 或正數": "Enter zero or a positive number for stock.",
      "陳列層請輸入正整數": "Shelf No. must be a positive whole number.",
      "必須要有名稱或條碼才能建立商品資訊卡。": "Enter a product name or barcode to create a product card.",
      ...
      "返回頂端": "Back to Top",
      "系統設定": "Settings",
      "系統設定與分析": "System Settings and Analytics",
      "管理分類標籤、匯入匯出與介面主題": "Manage categories, files, theme, and language",
      "- 管理分類標籤、資料備份與數據分析 -": "- Manage tags, backups, and analytics -",
      "新增分類": "Add Category",
      "輸入新分類名稱": "Enter a new category name",
      "資料儲存": "Data Storage",
      "商品資料會儲存在此 App 的本機 IndexedDB，不會自動上傳。": "Product data is stored in this app's local IndexedDB and is not uploaded automatically.",
      "請定期使用下方的「備份資料 JSON」保存備份；清除本 App 資料或移除 App 前務必先備份。": "Use Back Up JSON below regularly. Back up before clearing this app's data or removing the app.",
      "本機檔案位置": "Local File",
      ...
      "匯入會保留原有商品，合併上傳的商品資料。": "Importing keeps your existing products and merges product data from the selected file.",
      "介面模式": "Appearance",
      "明亮模式": "Light",
      "黑暗模式": "Dark",
      ...
      "執行：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "Implementation: GPT-5.3-Codex, GPT-5.5, GPT-5.6",
      "代碼：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "Code: GPT-5.3-Codex, GPT-5.5, GPT-5.6",
      "排版：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "Layout: GPT-5.3-Codex, GPT-5.5, GPT-5.6",
      "色彩：Gemini Web、GPT-5.5": "Color: Gemini Web, GPT-5.5",
      "字型：GenSekiGothic2TC": "Font: GenSekiGothic2TC",
      "翻譯：GPT-5.5、GPT-5.6": "Translation: GPT-5.5, GPT-5.6",
      "測試：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "Testing: GPT-5.3-Codex, GPT-5.5, GPT-5.6",
      ...
      "二.「使用者自行上傳之商品資訊（包含但不限於菸酒、藥品），應遵守相關法令規範。」": "2. Users are responsible for ensuring that product information they upload themselves, including but not limited to tobacco, alcohol, and medicines, complies with applicable laws and regulations.",
      "三.「本程式僅提供管理功能，不具備廣告或促銷意圖。」": "3. This app provides management features only and is not intended for advertising or promotion.",
      "四.「本 App 中文介面中的主頁副標短語為原創文案，僅作為使用體驗上的裝飾與提醒，不代表引用任何視聽、文學或其他作品原文，亦不代表與任何第三方作品、作者、出版社或影視公司存在合作、授權、贊助或背書關係。」": "4. The main-page subtitle phrases in this application's Chinese interface are original copy used solely as decorative and reminder elements for the user experience. They do not quote any audiovisual, literary, or other works, and do not imply collaboration, authorization, sponsorship, endorsement, or any other relationship with third-party works, authors, publishers, or film and television companies.",
      "版本": "Version",
      ...
      "- 說明資料儲存、相機權限與備份行為 -": "- Data storage, camera access, and backups -",
      "政策資訊": "Policy Information",
      "本隱私權與資料安全說明適用於：": "This privacy and data safety notice applies to:",
      "「商品終期電馭監管裝置」。": "Product Expiry Cyber Control.",
      ...
      "商品資料固定儲存在本機 IndexedDB；使用者可手動匯出 JSON 備份檔，自行保管、備份或刪除。": "Product data is stored in IndexedDB on this device. Users can manually export JSON backup files and keep, back up, or delete them themselves.",
      "商品效期趨勢分析與備份狀態只使用本機商品資料與本機設定即時計算；分析結果不會上傳或另存到遠端伺服器。": "Product expiry trend analysis and backup status are calculated in real time using only product data and settings on this device. Results are not uploaded or stored on remote servers.",
      "相機權限": "Camera Permission",
      "相機只用於條碼掃描。Android App 使用裝置內的 ML Kit 辨識條碼；網頁版則使用瀏覽器支援的條碼辨識能力。": "The camera is used only for barcode scanning. The Android app uses on-device ML Kit barcode recognition, while the web version uses the browser's built-in barcode-scanning capability when available.",
      ...
      "本 App 使用商品資料是為了在本機提供新增、編輯、刪除、搜尋、排序、月曆提醒、商品效期趨勢分析、CSV 匯出、JSON 備份與還原功能。": "The app uses product data locally to support adding, editing, deleting, searching, sorting, calendar reminders, product expiry trend analysis, CSV export, and JSON backup and restore.",
      ...
      "本機資料會保留在使用者裝置中，直到使用者刪除商品、清除本 App 或網站資料，或移除 App。": "Local data remains on the user's device until the user deletes products, clears app data or browser site data, or removes the app.",
      "使用者可在商品清單刪除個別商品，也可清除本 App 或瀏覽器網站資料、或移除 App 來刪除本機資料。": "Users can delete individual products from the product list. They can also delete local data by clearing app data or browser site data, or by removing the app.",
      "備份狀態僅記錄自上次 JSON 備份後新增或編輯的商品筆數，會與本機設定一併保留或刪除。": "Backup status shows how many products were added or edited since the last JSON backup. It is kept or deleted together with local settings.",
      "匯出的 CSV 或 JSON 檔案不會與本機資料自動同步；如不需保留，請自行刪除已保存的匯出或備份檔。": "Exported CSV or JSON files do not sync automatically with local app data. Delete saved exports or backups yourself when they are no longer needed.",
      ...
      "v2.4.1更新內容": "v2.4.1 Release Notes",
      "修復主頁點擊兩次返回鍵可以離開程式": "Fixed exiting the app by pressing Back twice on the home screen",
      "變更初始進入主頁動畫": "Changed the initial home-screen entrance animation",
      "添加分頁切換動畫": "Added page transition animations",
"v2.0.8更新內容": "v2.0.8 Release Notes",
      "v2.2.0更新內容": "v2.2.0 Release Notes",
      "v2.2.1更新內容": "v2.2.1 Release Notes",
      "v2.3.0更新內容": "v2.3.0 Release Notes",
      "刪除分頁讀取頁面": "Removed the page loading screen",
      "修正條碼顯示視窗最大寬度": "Fixed the maximum width of the barcode display dialog",
      "新增「庫存」與「陳列層」欄位": "Added Stock and Shelf No. fields",
      "統一設計提示視窗": "Unified notification design",
      "操作/版面最佳化": "Interaction and layout improvements",
      "v2.1.0更新內容": "v2.1.0 Release Notes",
      "排序功能新增名稱與條碼": "Added name and barcode sorting",
      "重新設計分析頁面": "Redesigned the analytics page",
      "修正分析頁的備份按鈕": "Fixed the analytics page backup button",
      "版面/操作最佳化": "Layout and interaction improvements",
      "虛擬鍵盤不再擋住新增/編輯商品視窗備註欄": "Virtual keyboard no longer covers the notes field in the Add/Edit Product dialog",
      "簡化資料儲存方式": "Simplified data storage",
      "操作/版面最佳化": "Interaction and layout improvements",
      "新增效期趨勢歷史分析": "Added expiry trend history analysis",
      "v2.0.5更新內容": "v2.0.5 Release Notes",
      "v2.0.3更新內容": "v2.0.3 Release Notes",
      "v2.0.2更新內容": "v2.0.2 Release Notes",
      "v2.0.1更新內容": "v2.0.1 Release Notes",
      "v2.0更新內容": "v2.0 Release Notes",
      "v1.9.0更新內容": "v1.9.0 Release Notes",
      "v1.8.10更新內容": "v1.8.10 Release Notes",
      "v1.8.9更新內容": "v1.8.9 Release Notes",
      "v1.8.7更新內容": "v1.8.7 Release Notes",
      "v1.8.5更新內容": "v1.8.5 Release Notes",
      "v1.8.3更新內容": "v1.8.3 Release Notes",
      "v1.8.1更新內容": "v1.8.1 Release Notes",
      ...
      "改善點擊延遲": "Improved interaction responsiveness",
      "改善程式操作延遲": "Improved app interaction responsiveness",
      "程式體驗最佳化": "Optimized app experience",
      "返回鍵更名為商品鍵": "Renamed the Back button to Products",
      "新增中文原創副標": "Added original Chinese home subtitles",
      "改善應用程式容量與效能": "Improved app size and performance",
      "提高頁面讀取速度": "Improved page loading speed",
      "新增商品效期趨勢分析": "Added product expiry trend analysis",
      "新增商品趨勢分析": "Added product trend analysis",
      "修正頁面閃爍與破圖": "Fixed page flicker and visual artifacts",
      "中文介面新增隨機出現裝飾性主頁副標": "Added randomly rotating decorative home-page subtitles to the Chinese interface",
      "統一資料讀取邏輯": "Unified data loading logic",
      "資料讀取最佳化": "Optimized data loading",
      "修正鏡頭掃描有機率發生閃退錯誤": "Fixed a possible camera scanning crash",
      "加入標題自訂功能": "Added title customization",
    ...
    ja: {
      ...
      "離線可用，支援手動輸入與鏡頭條碼掃描": "オフラインで利用でき、手入力とカメラでのバーコードスキャンに対応しています",
      "- 快速掌握商品效期，提前發現即期與過期風險 -": "- 商品期限とリスクを早めに把握 -",
      "新 增 商 品": "商 品 追 加",
      "設 定": "設 定",
      "系 統": "シ ス テ ム",
      "設定": "設定",
      ...
      "商 品": "商 品",
      "商品效期趨勢分析": "商品期限トレンド分析",
      "商 品 效 期 趨 勢 分 析": "商 品 期 限 ト レ ン ド 分 析",
      "備 份 資 料 J S O N": "J S O N バ ッ ク ア ッ プ",
      "應 用 程 式 資 訊": "ア プ リ 情 報",
      "依照目前商品資料即時計算效期與分類風險": "現在の商品データから期限と分類リスクをリアルタイムで計算",
      "- 依照目前商品資料即時計算效期與過期比例 -": "- 期限と期限切れ比率を即時計算 -",
      "商品效期概況": "商品期限の概要",
      "分類商品數量分布": "分類別商品数",
      "到期日時間分布趨勢": "期限日の推移",
      "商品分類健康狀態": "カテゴリーの状態",
      "分類商品即期風險": "分類別の期限間近リスク",
      "商品分類過期比例": "分類別商品の期限切れ比率",
      "分類商品過期比例": "分類別商品の期限切れ比率",
      "平均剩餘效期分析": "平均残り日数",
      "目前無法讀取本機 JSON 檔案，已暫時使用 IndexedDB 備援資料。請回設定頁重新選擇資料檔。": "現在ローカル JSON ファイルを読み取れないため、一時的に IndexedDB の予備データを使用しています。設定ページに戻ってデータファイルを選択し直してください。",
      "讀取中": "読み込み中",
      "商品類別": "商品分類",
      "商品筆數": "商品数",
      "筆": "件",
      ...
      "刪除數": "削除",
      "尚無歷史紀錄": "履歴はまだありません",
      "歷史資料會保留商品異動與到期的每月彙總；刪除商品不會清除既有統計。": "月ごとの商品変更と期限切れの集計を保存します。商品を削除しても、既存の統計は消えません。",
      "比例": "比率",
      "高風險": "高リスク",
      "中等風險": "中リスク",
      "低風險": "低リスク",
      ...
      "條碼掃描": "バーコードスキャン",
      "請把條碼對準鏡頭中央。相機影像只在本機辨識，不會上傳。": "バーコードをカメラ画面の中央に合わせてください。カメラ画像は端末内で認識され、アップロードされません。",
      "請把條碼對準鏡頭中央。": "バーコードをカメラ画面の中央に合わせてください。",
      "關閉掃描": "スキャンを閉じる",
      "打開手電筒": "ライトをオン",
      "長亮手電筒": "ライトを常時オン",
      "關閉手電筒": "ライトをオフ",
      ...
      "確定": "確定",
      "資料備份提醒": "データバックアップのご案内",
      "請先使用「備份資料 JSON 」建立備份，後續更新的版本只會使用本機 IndexedDB做為資料儲存方式 ，目前版本的程式會自動將先前指定的本機檔案位置匯入資料庫。若曾使用「本機檔案位置」，請在下一個程式版本更新前匯出JSON ，並在更新後用「還原資料 JSON 」恢復資料。": "先に「JSON バックアップ」でバックアップを作成してください。\n\n今後のバージョンでは、端末内の IndexedDB のみを保存先として使用します。現在のバージョンでは、以前に指定したローカルファイルをデータベースへ自動的にインポートします。\n\nローカルファイルを使用していた場合は、次のアプリ更新前に JSON を書き出し、更新後に「JSON バックアップを復元」でデータを復元してください。",
      "了解並繼續": "確認して続ける",
      "建議備份資料": "バックアップ推奨",
      ...
      "已將舊本機檔案資料移入本機資料庫，請匯出 JSON 建立新備份。": "以前のローカルファイルのデータを端末内データベースへ移行しました。新しいバックアップとして JSON を書き出してください。",
      "CSV 匯出成功": "CSVの書き出しが完了しました",
      "JSON 備份失敗": "JSONバックアップに失敗しました",
      "CSV 匯出失敗": "CSVの書き出しに失敗しました",
      "CSV 匯出": "CSVの書き出し",
      "JSON 還原": "JSON復元",
      "瀏覽器不支援確認檔案儲存": "このブラウザではファイルの保存完了を確認できません",
      "瀏覽器不支援確認檔案選擇": "このブラウザではファイル選択の結果を確認できません",
      ...
      "已取消選擇檔案": "ファイルの選択をキャンセルしました",
      "檔案寫入失敗": "ファイルへの書き込みに失敗しました",
      "無法開啟檔案選擇器": "ファイル選択画面を開けません",
      "檔案選擇器尚未就緒": "ファイル選択画面の準備ができていません",
      "無法開啟檔案": "ファイルを開けません",
      "原生條碼掃描失敗": "ネイティブのバーコードスキャンに失敗しました",
      "原生條碼掃描無法啟動": "ネイティブのバーコードスキャンを開始できません",
      "原生條碼掃描尚未就緒": "ネイティブのバーコードスキャンの準備ができていません",
      ...
      "庫存請輸入 0 或正數": "在庫には0または正の数を入力してください。",
      "陳列層請輸入正整數": "棚段には1以上の整数を入力してください。",
      "必須要有名稱或條碼才能建立商品資訊卡。": "商品情報カードを作成するには、商品名またはバーコードを入力してください。",
      ...
      "- 管理分類標籤、資料備份與數據分析 -": "- 分類タグ、バックアップ、分析を管理 -",
      "新增分類": "分類を追加",
      "輸入新分類名稱": "新しい分類名を入力",
      "資料儲存": "データ保存",
      "商品資料會儲存在此 App 的本機 IndexedDB，不會自動上傳。": "商品データはこのアプリの端末内 IndexedDB に保存され、自動的にアップロードされることはありません。",
      "請定期使用下方的「備份資料 JSON」保存備份；清除本 App 資料或移除 App 前務必先備份。": "下の「JSON バックアップ」を定期的に利用してください。このアプリのデータ消去や削除の前には必ずバックアップしてください。",
      "本機檔案位置": "ローカルファイル",
      ...
      "匯入會保留原有商品，合併上傳的商品資料。": "インポートすると既存の商品は保持され、選択したファイルの商品データが統合されます。",
      "介面模式": "表示設定",
      "明亮模式": "ライト",
      "黑暗模式": "ダーク",
      ...
      "執行：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "制作: GPT-5.3-Codex、GPT-5.5、GPT-5.6",
      "代碼：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "コード: GPT-5.3-Codex、GPT-5.5、GPT-5.6",
      "排版：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "レイアウト: GPT-5.3-Codex、GPT-5.5、GPT-5.6",
      "色彩：Gemini Web、GPT-5.5": "色彩: Gemini Web、GPT-5.5",
      "字型：GenSekiGothic2TC": "フォント: GenSekiGothic2TC",
      "翻譯：GPT-5.5、GPT-5.6": "翻訳: GPT-5.5、GPT-5.6",
      "測試：GPT-5.3-Codex、GPT-5.5、GPT-5.6": "テスト: GPT-5.3-Codex、GPT-5.5、GPT-5.6",
      "指示：GURESUTA": "ディレクション: GURESUTA",
      "發布：GURESUTA": "公開: GURESUTA",
      "隱私權與資料安全說明": "プライバシーとデータ安全性について",
      "免責聲明": "免責事項",
      "一.「本專案為開源工具，僅供個人管理商品效期使用。」": "一、本プロジェクトはオープンソースのツールであり、個人の商品期限管理のみを目的としています。",
      "二.「使用者自行上傳之商品資訊（包含但不限於菸酒、藥品），應遵守相關法令規範。」": "二、ユーザーが自らアップロードする商品情報（たばこ、酒類、医薬品などを含みますが、これらに限りません）は、関連する法令を遵守する必要があります。",
      "三.「本程式僅提供管理功能，不具備廣告或促銷意圖。」": "三、本アプリは管理機能のみを提供し、広告または販売促進を目的とするものではありません。",
      "四.「本 App 中文介面中的主頁副標短語為原創文案，僅作為使用體驗上的裝飾與提醒，不代表引用任何視聽、文學或其他作品原文，亦不代表與任何第三方作品、作者、出版社或影視公司存在合作、授權、贊助或背書關係。」": "四、本アプリ中国語版のホーム画面に表示されるサブタイトルは、ユーザー体験を補う装飾および注意喚起のためのオリジナル文です。視聴覚作品、文学作品その他の作品の原文を引用するものではなく、第三者の作品、著者、出版社または映像会社との協力、許諾、スポンサーシップ、推薦その他の関係を示すものでもありません。",
      "版本": "バージョン",
      ...
      "- 說明資料儲存、相機權限與備份行為 -": "- データ保存、カメラ権限、バックアップ -",
      "政策資訊": "ポリシー情報",
      "本隱私權與資料安全說明適用於：": "このプライバシーとデータ安全性に関する説明は、次のアプリに適用されます:",
      "「商品終期電馭監管裝置」。": "「商品期限サイバー管理装置」。",
      ...
      "商品資料固定儲存在本機 IndexedDB；使用者可手動匯出 JSON 備份檔，自行保管、備份或刪除。": "商品データは端末内のデータベース（IndexedDB）に保存されます。JSON バックアップは手動で書き出せるため、保管、バックアップ、削除はユーザー自身で行ってください。",
      "商品效期趨勢分析與備份狀態只使用本機商品資料與本機設定即時計算；分析結果不會上傳或另存到遠端伺服器。": "商品期限の傾向分析とバックアップ状況は、端末内の商品データと設定だけを使ってリアルタイムで計算されます。分析結果はアップロードされず、外部サーバーにも保存されません。",
      "相機權限": "カメラ権限",
      "相機只用於條碼掃描。Android App 使用裝置內的 ML Kit 辨識條碼；網頁版則使用瀏覽器支援的條碼辨識能力。": "カメラはバーコードスキャンのみに使用します。Android アプリでは端末内の ML Kit でバーコードを認識し、Web 版では対応している場合にブラウザ内蔵のバーコード認識機能を使用します。",
      "本專案不會儲存相機影像，不會錄音，也不會把影像傳送到遠端服務。": "本アプリはカメラ画像を保存せず、音声を録音せず、画像を外部サービスへ送信しません。",
      "若使用者拒絕相機權限，仍可手動輸入條碼與管理商品資料。": "カメラ権限を許可しない場合でも、バーコードを手入力して商品データを管理できます。",
      "資料使用與分享": "データの使用と共有",
      "本 App 使用商品資料是為了在本機提供新增、編輯、刪除、搜尋、排序、月曆提醒、商品效期趨勢分析、CSV 匯出、JSON 備份與還原功能。": "本アプリは、追加、編集、削除、検索、並び替え、カレンダー通知、商品期限の傾向分析、CSV 書き出し、JSON バックアップと復元を端末内で行うために商品データを使用します。",
      ...
      "資料保存與刪除": "データの保存と削除",
      "本機資料會保留在使用者裝置中，直到使用者刪除商品、清除本 App 或網站資料，或移除 App。": "ローカルデータは、商品を削除する、アプリのデータまたはブラウザのサイトデータを削除する、またはアプリを削除するまで端末内に残ります。",
      "使用者可在商品清單刪除個別商品，也可清除本 App 或瀏覽器網站資料、或移除 App 來刪除本機資料。": "商品リストから個別の商品を削除できます。アプリのデータまたはブラウザのサイトデータを削除するか、アプリを削除することでローカルデータを削除できます。",
      "備份狀態僅記錄自上次 JSON 備份後新增或編輯的商品筆數，會與本機設定一併保留或刪除。": "バックアップ状況には、前回の JSON バックアップ以降に追加または編集された商品の件数だけが表示されます。ローカル設定と一緒に保持または削除されます。",
      "匯出的 CSV 或 JSON 檔案不會與本機資料自動同步；如不需保留，請自行刪除已保存的匯出或備份檔。": "書き出した CSV または JSON ファイルは、アプリ内のローカルデータと自動同期されません。不要になった保存済みの書き出しファイルやバックアップは、ご自身で削除してください。",
      "資訊安全": "情報セキュリティ",
      "本 App 以本機儲存為主要設計，開發者不會主動接收使用者建立的商品資料。": "本アプリはローカル保存を前提として設計されています。ユーザーが別途送信しない限り、開発者が商品データを受け取ることはありません。",
      "請使用者自行保管裝置、瀏覽器資料與匯出的備份檔，避免未授權的人取得資料。": "端末、ブラウザのデータ、書き出したバックアップファイルは、第三者に取得されないようユーザー自身で管理してください。",
      "霓虹電馭": "ネオンサイバー",
      "日光電馭": "ライトサイバー",
      "活力綠洲": "活力オアシス",
      "深夜綠洲": "深夜オアシス",
      "目前版本：未設定": "現在のバージョン: 未設定",
      "v2.4.1更新內容": "v2.4.1 更新内容",
      "修復主頁點擊兩次返回鍵可以離開程式": "ホーム画面で戻るキーを2回押してアプリを終了できるように修正",
      "變更初始進入主頁動畫": "起動時のホーム画面表示アニメーションを変更",
      "添加分頁切換動畫": "ページ切替アニメーションを追加",
"v2.0.8更新內容": "v2.0.8 更新内容",
      "v2.2.0更新內容": "v2.2.0 更新内容",
      "v2.2.1更新內容": "v2.2.1 更新内容",
      "v2.3.0更新內容": "v2.3.0 更新内容",
      "刪除分頁讀取頁面": "ページ切替時の読み込み画面を削除",
      "修正條碼顯示視窗最大寬度": "バーコード表示ダイアログの最大幅を修正",
      "新增「庫存」與「陳列層」欄位": "「在庫」と「棚段」項目を追加",
      "統一設計提示視窗": "通知表示のデザインを統一",
      "操作/版面最佳化": "操作性とレイアウトを最適化",
      "v2.1.0更新內容": "v2.1.0 更新内容",
      "排序功能新增名稱與條碼": "並び替えに商品名とバーコードを追加",
      "重新設計分析頁面": "分析ページを再設計",
      "修正分析頁的備份按鈕": "分析ページのバックアップボタンを修正",
      "版面/操作最佳化": "レイアウトと操作性を最適化",
      "虛擬鍵盤不再擋住新增/編輯商品視窗備註欄": "仮想キーボードが商品追加／編集画面のメモを覆わないように改善",
      "簡化資料儲存方式": "データ保存方式を簡素化",
      "操作/版面最佳化": "操作性とレイアウトを最適化",
      "新增效期趨勢歷史分析": "期限推移の履歴分析を追加",
      "v2.0.5更新內容": "v2.0.5 更新内容",
      "v2.0.3更新內容": "v2.0.3 更新内容",
      "v2.0.2更新內容": "v2.0.2 更新内容",
      "v2.0.1更新內容": "v2.0.1 更新内容",
      "v2.0更新內容": "v2.0 更新内容",
      "v1.9.0更新內容": "v1.9.0 更新内容",
      "v1.8.10更新內容": "v1.8.10 更新内容",
      "v1.8.9更新內容": "v1.8.9 更新内容",
      "v1.8.7更新內容": "v1.8.7 更新内容",
      "v1.8.5更新內容": "v1.8.5 更新内容",
      "v1.8.3更新內容": "v1.8.3 更新内容",
      "v1.8.1更新內容": "v1.8.1 更新内容",
      ...
      "版面最佳化": "レイアウトを最適化しました",
      "改善點擊延遲": "タップ操作の遅延を改善しました",
      "改善程式操作延遲": "アプリ操作の遅延を改善しました",
      "程式體驗最佳化": "アプリ体験を最適化しました",
      "返回鍵更名為商品鍵": "戻るボタンを「商品」ボタンに改称しました",
      "新增中文原創副標": "中国語のオリジナルホーム副題を追加しました",
      "改善應用程式容量與效能": "アプリの容量とパフォーマンスを改善しました",
      "提高頁面讀取速度": "ページの読み込み速度を向上しました",
      "新增商品效期趨勢分析": "商品期限トレンド分析を追加",
      "新增商品趨勢分析": "商品トレンド分析を追加",
      "修正頁面閃爍與破圖": "ページのちらつきと表示崩れを修正しました",
      "中文介面新增隨機出現裝飾性主頁副標": "中国語インターフェースにランダム表示の装飾的なホーム画面副題を追加",
      "統一資料讀取邏輯": "データ読み込みロジックを統一しました",
      "資料讀取最佳化": "データ読み込みを最適化しました",
      "修正鏡頭掃描有機率發生閃退錯誤": "カメラスキャンでまれに発生するクラッシュを修正しました",
      "加入標題自訂功能": "タイトルカスタマイズ機能を追加",
  ...
  const patterns = [
    ...
    [/^已新增或編輯(\d+)筆商品，已備份$/, { en: "Added or edited $1 products ;\nbacked up", ja: "$1件の商品を追加または編集済み、\nバックアップ済み" }],
    [/^已新增或編輯(\d+)筆商品，尚未備份$/, { en: "Added or edited $1 products ;\nnot backed up", ja: "$1件の商品を追加または編集済み、\n未バックアップ" }],
