(function () {
  ...
  const dictionaries = {
    en: {
      ...
      "分類商品數量分布": "Category Product Count Distribution",
      "到期日時間分布趨勢": "Expiry Date Trend",
      "商品分類健康狀態": "Category Health Status",
      "分類商品即期風險": "Category Imminent Expiry Risk",
      "商品分類過期比例": "Expired Ratio by Category",
      "分類商品過期比例": "Expired Ratio by Category",
      "平均剩餘效期分析": "Average Remaining Shelf Life",
      ...
      "中等風險": "Medium Risk",
      "低風險": "Low Risk",
      "平均效期天數": "Average Shelf Life Days",
      "天": " days",
      "無資料": "No data",
      ...
      "商品效期趨勢分析與備份狀態只使用本機商品資料與本機設定即時計算；分析結果不會上傳或另存到遠端伺服器。": "Product expiry trend analysis and backup status are calculated in real time from local product data and local settings only. Analysis results are not uploaded or separately stored on remote servers.",
      ...
      "備份狀態僅記錄自上次 JSON 備份後新增或編輯的商品筆數，會與本機設定一併保留或刪除。": "Backup status records only how many products were added or edited since the last JSON backup. It is retained or deleted together with local settings.",
    ...
    ja: {
      ...
      "商品效期概況": "商品期限の概要",
      "分類商品數量分布": "分類別の商品数分布",
      "到期日時間分布趨勢": "期限日の時間分布トレンド",
      "商品分類健康狀態": "商品分類の健全性",
      "分類商品即期風險": "分類別商品の期限間近リスク",
      ...
      "四.「本 App 中文介面中的主頁副標短語為原創文案，僅作為使用體驗上的裝飾與提醒，不代表引用任何視聽、文學或其他作品原文，亦不代表與任何第三方作品、作者、出版社或影視公司存在合作、授權、贊助或背書關係。」": "四、本 App 中国語インターフェースのホーム画面副標短語はオリジナル文案であり、使用体験上の装飾および注意喚起のみを目的としています。視聴覚作品、文学作品その他の作品の原文を引用するものではなく、第三者の作品、著者、出版社または映像会社との協力、許諾、スポンサーシップ、推薦その他の関係を示すものでもありません。",
      "版本": "バージョン",
      ...
      "政策資訊": "ポリシー情報",
      "本隱私權與資料安全說明適用於：": "本プライバシーおよびデータ安全性に関する説明は、以下に適用されます:",
      "「商品終期電馭監管裝置」。": "「商品期限サイバー管理装置」。",
      ...
      "商品效期趨勢分析與備份狀態只使用本機商品資料與本機設定即時計算；分析結果不會上傳或另存到遠端伺服器。": "商品期限トレンド分析とバックアップ状態は、端末内の商品データとローカル設定のみを使ってリアルタイムに計算されます。分析結果はアップロードされず、外部サーバーに別途保存されません。",
      "相機權限": "カメラ権限",
      ...
      "資料使用與分享": "データの使用と共有",
      "本 App 使用商品資料是為了在本機提供新增、編輯、刪除、搜尋、排序、月曆提醒、商品效期趨勢分析、CSV 匯出、JSON 備份與還原功能。": "本アプリは、追加、編集、削除、検索、並び替え、カレンダー通知、商品期限トレンド分析、CSV 書き出し、JSON バックアップと復元を端末内で行うために商品データを使用します。",
      ...
      "備份狀態僅記錄自上次 JSON 備份後新增或編輯的商品筆數，會與本機設定一併保留或刪除。": "バックアップ状態は、前回の JSON バックアップ後に追加または編集された商品件数のみを記録します。ローカル設定と一緒に保持または削除されます。",
