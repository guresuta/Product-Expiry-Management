(function () {
  ...
  const dictionaries = {
    en: {
      ...
      "- 快速掌握商品效期，提前發現即期與過期風險  -": "- Quickly track product expiry dates and spot near-expiry or expired risks early -",
      "新 增 商 品": "Add Product",
      "設 定": "Settings",
      "系 統": "System",
      "設定": "Settings",
      ...
      "依照目前商品資料即時計算效期與過期比例": "Real-time expiry and expired-ratio analysis from current product data",
      ...
      "商品分類過期比例": "Category Expired Ratio",
      ...
      "管理分類標籤、資料備份與數據分析": "Manage category tags, data backup, and analytics",
      "新增分類": "Add Category",
    ...
    ja: {
      ...
      "- 快速掌握商品效期，提前發現即期與過期風險  -": "- 商品期限をすばやく把握し、期限間近と期限切れリスクを早めに発見 -",
      "新 增 商 品": "商 品 追 加",
      "設 定": "設 定",
      "系 統": "シ ス テ ム",
      "設定": "設定",
      ...
      "依照目前商品資料即時計算效期與過期比例": "現在の商品データから期限と期限切れ比率をリアルタイムで計算",
      "商品效期概況": "商品期限の概要",
      "分類商品數量分布": "分類別の商品数分布",
      "到期日時間分布趨勢": "期限日の時間分布トレンド",
      "商品分類健康狀態": "商品分類の健全性",
      "分類商品即期風險": "分類別商品の期限間近リスク",
      "商品分類過期比例": "商品分類の期限切れ比率",
      "平均剩餘效期分析": "平均残存期限分析",
      ...
      "管理分類標籤、資料備份與數據分析": "分類タグ、データバックアップ、分析を管理",
      "新增分類": "分類を追加",
      "輸入新分類名稱": "新しい分類名を入力",
      "資料儲存": "データ保存",
      "本機檔案位置": "ローカルファイル",
